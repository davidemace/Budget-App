-- Repair databases that were migrated with the older Phase 1 schema.
-- This intentionally rebuilds the single-user planning database to match the
-- Phase 2 Worker code exactly.
